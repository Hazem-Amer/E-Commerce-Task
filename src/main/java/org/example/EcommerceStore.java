...
public class EcommerceStore {
    ...
    private EcommerceStore() {
        ...
        Product scratchCard = new Product("Scratch Card", 20f, 3f);
        Product tv = new ShippableProducts("TV", 200f, 3f,5f);

        cart.addToCart(cheese, 2f);
        cart.addToCart(tv, 1f);
        cart.addToCart(scratchCard, 1f);
        checkoutService.checkout(customer,cart);

        /*Throws product expired exception*/
//        Product expiredMilk = new Product("Milk", 50f, 2f, LocalDate.now().minusDays(1), true);
//        Customer sami = new Customer("Sami", 500f);
//
//        cart.addToCart(expiredMilk, 1f);
...
//        Product biscuits = new Product("Biscuits", 80f, 1f, LocalDate.now().plusDays(3), true);
//        Customer alaa = new Customer("Alaa", 400f);
//
//        cart.addToCart(biscuits, 3f);
//        checkoutService.checkout(alaa, cart);


        /*insufficient Balance exception*/
//        Product laptop = new ShippableProducts("Laptop", 900f, 2f, 2f);
//        Customer omar = new Customer("Omar", 500f); // not enough for Laptop
//
//        cart.addToCart(laptop, 1f);
